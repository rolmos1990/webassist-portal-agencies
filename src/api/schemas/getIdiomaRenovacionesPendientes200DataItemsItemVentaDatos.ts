 ...
 */
import type { GetIdiomaRenovacionesPendientes200DataItemsItemVentaDatosDocumentosItem } from './getIdiomaRenovacionesPendientes200DataItemsItemVentaDatosDocumentosItem';

export type GetIdiomaRenovacionesPendientes200DataItemsItemVentaDatos = {
  id?: string;
  ...
  documentos?: GetIdiomaRenovacionesPendientes200DataItemsItemVentaDatosDocumentosItem[];
  cliente?: string;
};
